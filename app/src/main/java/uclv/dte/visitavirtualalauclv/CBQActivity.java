...
public class CBQActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Bitmap bm = null;
        try {
            bm = getBitmapFromAsset("slider/img/cbq/CBQ.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void crearDialogoSlider() {
        ...
        alert.setTitle(getString(R.string.title_activity_cbq));
        wv.loadUrl("file:///android_asset/slider/cbq_"+lenguage+".html");
