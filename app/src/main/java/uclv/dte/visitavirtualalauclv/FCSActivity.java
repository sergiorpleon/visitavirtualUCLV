...
public class FCSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bm = null;
        try {
            bm = getBitmapFromAsset("slider/img/humanidades/Ciencias Sociales.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void crearDialogoSlider() {
        ...
        alert.setTitle(getString(R.string.title_activity_fcs));
        wv.loadUrl("file:///android_asset/slider/sociales_"+lenguage+".html");
