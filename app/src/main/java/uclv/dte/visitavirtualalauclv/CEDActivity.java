...
public class CEDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bm = null;
        try {
            bm = getBitmapFromAsset("slider/img/ced/ced.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void crearDialogoSlider() {
        ...
        alert.setTitle(getString(R.string.title_activity_ced));
        wv.loadUrl("file:///android_asset/slider/ced_"+lenguage+".html");
