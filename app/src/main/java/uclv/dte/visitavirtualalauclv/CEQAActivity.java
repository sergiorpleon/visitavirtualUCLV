...
public class CEQAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bm = null;
        try {
            bm = getBitmapFromAsset("slider/img/ceqa/ceqa.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void crearDialogoSlider() {
        ...
        alert.setTitle(getString(R.string.title_activity_ceqa));
        wv.loadUrl("file:///android_asset/slider/ceqa_"+lenguage+".html");
