...
public class FCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bm = null;
        try {
            bm = getBitmapFromAsset("slider/img/cei/CEI.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void crearDialogoSlider() {
        ...
        alert.setTitle(getString(R.string.title_activity_fc));
        wv.loadUrl("file:///android_asset/slider/construccion_"+lenguage+".html");
